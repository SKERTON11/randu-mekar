        ...
        <div class="row g-4 mb-5">
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <a href="https://wa.me/<?= WHATSAPP_NUMBER ?>" class="contact-card d-block text-decoration-none" target="_blank">
                    ...
                    <div style="font-size:0.85rem;color:#7A6050">+62 812-XXXX-XXXX</div>
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-7" data-aos="fade-left">
                    ...
                    <div style="display:grid;gap:1rem">
                        ...
                        <div style="display:flex;gap:12px;align-items:flex-start">
                            ...
                            <div>
                                ...
                                <div style="font-size:0.85rem;color:#7A6050">Senin – Sabtu: 08.00 – 17.00 WIB<br>Minggu: 09.00 – 14.00 WIB</div>
                            </div>
                        </div>
                        <div style="display:flex;gap:12px;align-items:flex-start">
                            <div style="width:38px;height:38px;background:var(--putih);border-radius:10px;display:flex;align-items:center;justify-content:center;flex-shrink:0;box-shadow:0 2px 8px var(--shadow)">
                ...
                <div style="border-radius:20px;overflow:hidden;box-shadow:0 4px 20px var(--shadow)">
                    <iframe 
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63244.39789456802!2d110.77939259999999!3d-7.6918065!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a3f37d62d3b6d%3A0x5027a76e3555360!2sSukoharjo%2C%20Jawa%20Tengah!5e0!3m2!1sid!2sid!4v1700000000000!5m2!1sid!2sid"
                        width="100%" 
                        height="350" 
                ...
                <p style="font-size:0.78rem;color:#7A6050;text-align:center;margin-top:8px">
                    📌 Ganti koordinat maps sesuai lokasi toko Anda di file kontak.php
                </p>
            </div>
        </div>
    </div>
